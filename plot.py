...
plt.ylabel(r'Zählrate $Z/ \si{\per\second}$')
plt.xlabel(r'effektive Länge $x / \si{\centi\meter}$')
plt.legend(loc='best')
...
plt.ylabel(r'Energie $E / \si{mega\electronvolt}$')
plt.xlabel(r'effektive Länge $x / \si{\centi\meter}$')
plt.legend(loc='best')
...
plt.grid(True, which='both')
plt.plot(x, y, 'bx', label=r'Messwerte')
plt.axhline(y = n1, label=r'1/2 Zählrate')
